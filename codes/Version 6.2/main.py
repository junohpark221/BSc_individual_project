    ...
    if (intra_type == 'RGG') and (inter_type == 'RGG'):
            ...
            for cur_node in range((cur_layer * nodes), (cur_layer + 1) * nodes):
                for target_node in range((cur_layer + 1) * nodes, (cur_layer + 2) * nodes):
                    ...
                    if d <= inter_thres:
                        ...
                        if cur_node == rgg_supp_nodes[target_node][1]:
                            for_supp_edges += 1
                        else:
                            for_edges += 1

                        if target_node == rgg_supp_nodes[cur_node][1]:
                            back_supp_edges += 1
                        else:
                            back_edges += 1
        ...
        if cur_layer != (len(layer_names) - 1):
            ...
            for target_node in target_nodes:
                if rand_supp_nodes[target_node][1] in cur_nodes:
                    net[rand_supp_nodes[target_node][1], target_node, layer_names[cur_layer], layer_names[cur_layer + 1]] = 1
                    inter_rand_edges.append((rand_supp_nodes[target_node][1], target_node, layer_names[cur_layer], layer_names[cur_layer + 1]))
                    for_supp_edges += 1
            ...
            for cur_node in cur_nodes:
                if rand_supp_nodes[cur_node][1] in target_nodes:
                    net[rand_supp_nodes[cur_node][1], cur_node, layer_names[cur_layer + 1], layer_names[cur_layer]] = 1
                    inter_rand_edges.append((rand_supp_nodes[cur_node][1], cur_node, layer_names[cur_layer + 1], layer_names[cur_layer]))
                    back_supp_edges += 1
    ...
    if (intra_type == 'RGG') and (inter_type == 'RGG'):
        for cur_layer in range(len(layer_names)):
            ...
            for cur_node in range(cur_layer * nodes, (cur_layer + 1) * nodes):
                ...
                rgg_supp_nodes.append((cur_node, short_node))
                if short_node != -1:
        ...
        for cur_layer in range(len(layer_names)):
            ...
            for cur_node in cur_layer_nodes:
                rand_supp_nodes.append((cur_node, target_nodes[index]))
                index += 1
...
if __name__ == "__main__":
    ...
    supp_len = 0
    for node in rgg_supp_nodes:
        if node[1] != -1:
            supp_len += 1

    print("\nLength of the supporting node: ", supp_len)
    ...
    # att_rgg_rgg_net = cas.attack_network(rgg_rgg_net, coords, rgg_supp_nodes, attack_type, graph_type="RGG_RGG", attack_size=attack_size, attack_point=(0.5, 0.5))
    ...
    # att_rgg_rand_net = cas.attack_network(rgg_rand_net, coords, rand_supp_nodes, attack_type, graph_type="RGG_Rand", attack_size=attack_size, attack_point=(0.5, 0.5))
    ...
    # att_rand_rgg_net = cas.attack_network(rand_rgg_net, coords, rgg_supp_nodes, attack_type, graph_type="Rand_RGG", attack_size=attack_size, attack_point=(0.5, 0.5))
    ...
    att_rand_rand_net = cas.attack_network(rand_rand_net, coords, rand_supp_nodes, attack_type, graph_type="Rand_Rand", attack_size=attack_size, attack_point=(0.5, 0.5))
